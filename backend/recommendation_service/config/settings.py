...
MIDDLEWARE = [
    'recommendation_service.settings.RequestLoggingMiddleware',
...
class RequestLoggingMiddleware:
    ...
    def __call__(self, request):
        print(f"MIDDLEWARE: {request.method} {request.path} - {request.resolver_match}")
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API for personalized excursion recommendations',
    'VERSION': '1.0.0',
