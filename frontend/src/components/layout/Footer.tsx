                    ...
                    <div>
                        ...
                        <ul className='space-y-2'>
                            <li className='text-gray-400'>
                                <span className='block'>Ирина Руснак:</span>
                                <a
                            ...
                            <li className='text-gray-400'>
                                <span className='block'>Виктория Волкова:</span>
                                <a
                            ...
                            <li className='text-gray-400'>
                                <span className='block'>Наталья Лапшина:</span>
                                <a
                                    href='tel:+79993456789'
                                    className='hover:text-white transition-colors'
                                >
                                    +7 (999) 345-67-89
                                </a>
