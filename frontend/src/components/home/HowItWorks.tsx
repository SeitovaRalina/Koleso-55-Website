  ...
  const steps = [
    {
      ...
      description: 'Найдите идеальную экскурсию из нашего каталога',
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Выберите удобное время и оформите заказ онлайн',
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Получите билеты и наслаждайтесь путешествием',
    },
  ];
